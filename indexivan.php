     	...
     	function resize() {
     		...
     		$.each(scope.origin, function(index, val) {     			
     			if (index != "USA") {
					...
					rec.attr("x", x)
		     		   .attr("y", y)
	     			   .attr("width", function(){console.log(nw); return nw;})
	     			   .attr("height", nw)
	     			   .attr("fill", function(){
	     			   		console.log("nw:");
	     			   		console.log(nw);
	     			   ...
	     			   .on("click", function(){
	     			   		...
	     			   		scope.$apply(function(){
	     			   			...
	     			   			scope.select_ctry = scope.select_origin[id].ctry_orig;	     			   			
	     			   		});
	     			   		scope.tooltip = true;	     			   		
	     			   });
	     		}
	     			   ...
	     			   .on("click", function(){
	     			        var id = $(this).attr("id").split("_")[0];
	     			   		scope.$apply(function(){
	     			   			scope.select_destiny = scope.destiny[id];
	     			   			scope.select_origin  = scope.origin[id];	
	     			   			scope.select_ctry = scope.select_destiny[id].ctry_dest;	     			   			
	     			   			scope.select_destiny_length = $.map(scope.destiny[id], function(n, i) { return i; }).length - 5;
	     			   			scope.select_origin_length  = $.map(scope.origin[id], function(n, i) { return i; }).length - 5;	
	     			   		});
	     			   		scope.tooltip = true;	     			   		
...
<body ng-controller="indexCtrl" id="body">
	<div class="content">
		<div class="ocultar_menu">		
			<div class="header">
	   			<div id="title_main">MIGRACIÓN IBEROAMERICANA</div>
				<div class="lang_version">
	   				<img id="lang" src="images/eng_button.png">
	  			</div>
	  		</div>
		...
		<div class="contenido">
			...
			<div id="Origin" ng-click="show(1)" ng-class="{activo:menu == 1}">
				<p>Origen</p><i class="fa fa-caret-down"></i>
			</div>
			<div id="Destiny" ng-click="show(2)" ng-class="{activo:menu == 2}">
				<p>Destino</p><i class="fa fa-caret-down"></i>
			</div>
			<div class="menu_paises">
				<div id="menu_origen" class="menu" ng-show="menu == 1">
					<div class="checkboxFive">
						<input id="All_O" type="checkbox" name="Todos">
						<label for="All_O"></label>Todos</div>
					<div class="checkboxFive" ng-repeat="pais in countries_esp">
						<input class="check" id="{{pais}}_O" type="checkbox" name="pais" ng-model="model_origin_esp[pais.split(' ')[0].split('ñ')[0]]">
						<label for="{{pais}}_O"></label>{{pais}}</div>
				</div>
				<div id="menu_destino" class="menu" ng-show="menu == 2">
					<div class="checkboxFive">
						<input id="All_D" type="checkbox" name="Todos">
						<label for="All_D"></label>Todos</div>
					<div class="checkboxFive" ng-repeat="pais in countries_esp">
						<input class="check" id="{{pais}}_D" type="checkbox" name="pais" ng-model="model_destiny_esp[pais.split(' ')[0].split('ñ')[0]]">
						<label for="{{pais}}_D"></label>{{pais}}</div>
				</div>
			</div>
			<div class="infoExtra">
			...
			<div id="tooltip_esp" ng-show="tooltip">
				...
				<div class="chart" ng-repeat="entrada in select_origin | limitTo:select_origin_length" ng-show="entrada.ctry_orig">
					<div class="cantidad2">{{entrada.ctry_orig}}:{{entrada['yr'+select_year]}}</div>
					<div class="barra">
				...
				<div class="chart" ng-repeat="salida in select_destiny | limitTo:select_destiny_length" ng-show="salida.ctry_dest">
					<div class="cantidad2">{{salida.ctry_dest}}:{{salida['yr'+select_year]}}</div>
					<div class="barra">
				...
				<!--svg width="320" height="190">
					<text class="country" x="25" y="20">Mexico /</text> <text class="year" x="100" y="20">2010</text>
					<text class="datos" x="25" y="50">Entraron</text><text id="entrar" class="cantidad" x="305" y="50">312452</text>
					<rect class="grey_sec" id="entrar_pais_gris" x="25" y="58" stroke="#DBE2E4" fill="#DBE2E4" stroke-miterlimit="10" width="283" height="13"/>
					<rect class="blue_sec" id="entrar_pais_azul" x="25" y="58" stroke="#3F9DDC" fill="#3F9DDC" stroke-miterlimit="10" width="141" height="13"/>
					<text class="datos" x="25" y="98">Salieron</text><text id="salir" class="cantidad" x="305" y="98">5467834</text>
					<rect class="grey_sec" id="salir_pais_gris" x="25" y="106" stroke="#DBE2E4" fill="#DBE2E4" stroke-miterlimit="10" width="283" height="13"/>
					<rect class="blue_sec" id="salir_pais_azul" x="25" y="106" stroke="#3F9DDC" fill="#3F9DDC" stroke-miterlimit="10" width="233" height="13"/>
					<text class="datos" x="25" y="147">Salieron a Estados Unidos</text><text id="salir_usa" class="cantidad" x="305" y="147">24345</text>
					<rect class="grey_sec" id="salir_pais_gris" x="25" y="154" stroke="#DBE2E4" fill="#DBE2E4" stroke-miterlimit="10" width="283" height="13"/>
					<rect class="blue_sec" id="salir_pais_azul" x="25" y="154" stroke="#3F9DDC" fill="#3F9DDC" stroke-miterlimit="10" width="184" height="13"/>
				</svg-->
			...
			<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="686.001px" height="820.915px" viewBox="-20.573 155.716 686.001 820.915"	 enable-background="new -20.573 155.716 686.001 820.915" xml:space="preserve">
				<g id="MAPA">
					<g>
						<g>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="414.762,282.893 415.583,284.947 411.075,286.996 
								404.92,286.996 403.278,284.535 404.508,282.484 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="228.513,303.816 233.021,295.611 234.664,284.947 
								232.201,282.893 230.971,283.302 228.513,287.405 225.638,288.226 225.228,303.816 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="278.972,356.329 273.638,351.815 270.356,345.663 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="322.458,255.409 326.561,258.278 334.767,260.331 
								...
								315.894,253.355 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="315.894,250.076 318.767,251.716 318.767,253.355 
								317.537,253.355 310.561,248.021 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="277.329,253.764 278.15,257.048 274.46,257.458 
								275.69,253.764 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="366.353,270.996 367.997,276.738 366.353,282.072 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="218.665,322.688 229.743,327.201 233.846,327.201 
								237.125,325.561 236.303,321.458 231.382,321.458 223.998,316.943 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="232.612,305.459 228.513,303.816 225.228,303.816 
								...
								232.201,307.507 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="356.508,278.792 358.15,280.841 355.277,280.023 
								354.458,278.792 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="358.15,269.354 359.379,270.175 357.743,269.766 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="366.353,270.996 367.997,276.738 366.353,282.072 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="273.638,312.432 266.664,306.688 259.279,303.816 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="323.278,282.893 329.434,284.947 330.663,287.405 
								326.97,286.996 323.278,288.635 318.767,288.226 313.431,284.123 317.125,282.072 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="162.46,218.893 146.05,213.563 141.127,202.896 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="16.411,199.611 15.591,198.793 16.411,196.742 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="38.153,190.587 39.796,188.945 40.205,192.639 
								38.153,192.23 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="270.356,345.663 269.126,341.558 273.638,312.432 
								...
								266.664,347.303 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="285.944,372.328 284.714,374.383 286.356,375.199 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="321.228,364.535 320.815,366.178 322.869,369.869 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="315.894,210.28 317.125,212.329 308.51,211.099 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="356.508,257.869 356.099,260.331 351.587,261.563 
								351.587,259.918 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points
			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="507.483,415.818 509.944,413.356 511.174,405.152 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="457.02,392.844 452.098,385.047 453.739,380.535 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="477.534,599.612 473.02,593.867 469.333,592.224 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="384.407,577.864 382.355,581.557 376.611,583.196 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="491.073,419.096 487.381,414.994 484.504,408.016 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="454.559,347.712 452.918,352.636 446.764,353.457 
								450.045,350.584 448.817,347.712 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="481.225,689.455 487.792,688.628 493.125,693.148 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="370.458,338.278 365.945,339.918 360.202,346.072 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="430.356,344.021 431.584,345.663 429.944,346.481 
								427.073,345.251 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="317.125,375.199 318.767,372.328 319.998,372.738 
							...
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="450.458,299.713 447.997,300.943 447.997,303.816 
								452.098,301.353 			"/>
							<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="452.506,313.252 454.967,316.943 453.739,316.943 			"/>
							<polyline fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="254.357,336.224 259.279,339.918 260.92,344.021 
								254.357,342.379 252.715,336.224 254.357,336.224 			"/>
					</g>
					<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="4.04,645.348 6.417,662.736 -5.442,707.008 -0.702,713.33 
					...
					<polygon fill="#DCE3E5" stroke="#FFFFFF" stroke-width="1.5" points="113.136,612.143 129.735,624.794 147.134,627.954 
				...
				<g>
					<text id="CHL_T" ng-show="model_destiny_esp.Chile || model_origin_esp.Chile" x="366.5542" y="684.5742" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">CHL</text>
				</g>
				...
				<g>
					<text id="BRA_T" ng-show="model_destiny_esp.Brasil || model_origin_esp.Brasil" x="549.5464" y="548.1113" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">BRA</text>
				</g>
				...
				<g>
					<text id="BOL_T" ng-show="model_destiny_esp.Bolivia || model_origin_esp.Bolivia" x="416.8374" y="587.0869" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">BOL</text>
				</g>
				...
				<g>
					<text id="ARG_T" ng-show="model_destiny_esp.Argentina || model_origin_esp.Argentina" x="413.7544" y="773.2285" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">ARG</text>
				</g>
				...
				<g>
					<text id="COL_T" ng-show="model_destiny_esp.Colombia || model_origin_esp.Colombia" x="350.1245" y="413.0288" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">COL</text>
				</g>
				...
				<g>
					<text id="CUB_T" ng-show="model_destiny_esp.Cuba || model_origin_esp.Cuba" x="312.1484" y="278.6816" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">CUB</text>
				</g>
				<rect class="origen" id="DOM_O" ng-show="model_origin_esp.Republica" x="354.704" y="266.248" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="31.512" height="31.515"/>
				<rect id="DOM_D" ng-show="model_destiny_esp.Republica" x="354.704" y="266.248" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="31.512" height="31.515"/>
				<g>
					<text id="DOM_T" ng-show="model_destiny_esp.Republica || model_origin_esp.Republica" x="357.5073" y="287.7861" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">DOM</text>
				</g>
				...
				<g>
					<text id="CRI_T" ng-show="model_destiny_esp.Costa || model_origin_esp.Costa" x="228.4429" y="377.0405" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">CRI</text>
				</g>
				...
				<g>
					<text id="ECU_T" ng-show="model_destiny_esp.Ecuador || model_origin_esp.Ecuador" x="300.1064"  y="452.9326" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">ECU</text>
				</g>
				...
				<g>
					<text id="SLV_T" ng-show="model_destiny_esp.El || model_origin_esp.El" x="215.9009" y="338.4697" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">SLV</text>
				</g>
				...
				<g>
					<text id="GTM_T" ng-show="model_destiny_esp.Guatemala || model_origin_esp.Guatemala" x="182.7744" y="323.1826" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">GTM</text>
				</g>
				...
				<g>
					<text id="HND_T" ng-show="model_destiny_esp.Honduras || model_origin_esp.Honduras" x="213.2646" y="308.2407" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">HND</text>
				</g>
				<rect class="origen" id="MEX_O" ng-show="model_origin_esp.Mexico" x="114.483" y="235.112" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="31.155" height="31.151"/>
				<rect id="MEX_D" ng-show="model_destiny_esp.Mexico" x="114.483" y="235.112" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="31.155" height="31.151"/>
				<g>
					<text id="MEX_T" ng-show="model_origin_esp.Mexico || model_destiny_esp.Mexico" x="118.5371" y="253.9023" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">MEX</text>
				</g>
				...
				<g>
					<text id="NIC_T" ng-show="model_destiny_esp.Nicaragua || model_origin_esp.Nicaragua" x="259.0039" y="319.543" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">NIC</text>
				</g>
				...
				<g>
					<text id="VEN_T" ng-show="model_destiny_esp.Venezuela || model_origin_esp.Venezuela" x="413.0347" y="381.8262" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">VEN</text>
				</g>
				...
				<g>
					<text id="URY_T" ng-show="model_destiny_esp.Uruguay || model_origin_esp.Uruguay" x="482.9819" y="729.0635" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11.8075">URY</text>
				</g>
				...
				<g>
					<text id="PRI_T" ng-show="model_destiny_esp.Puerto || model_origin_esp.Puerto" x="404.312" y="294.0684" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">PRI</text>
				</g>
				...
				<g>
					<text id="PRT_T" ng-show="model_destiny_esp.Portugal || model_origin_esp.Portugal" x="-1.0713" y="698.252" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">PRT</text>
				</g>
				<rect class="origen" id="PER_O" ng-show="model_origin_esp.Peru" x="338.046" y="528.941" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="48.082" height="48.083"/>
				<rect id="PER_D" ng-show="model_destiny_esp.Peru" x="338.046" y="528.941" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="48.082" height="48.083"/>
				<g>
					<text id="PER_T" ng-show="model_destiny_esp.Peru || model_origin_esp.Peru" x="351.4097" y="556.2891" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">PER</text>
				</g>
				...
				<g>
					<text id="PRY_T" ng-show="model_destiny_esp.Paraguay || model_origin_esp.Paraguay" x="470.4204" y="642.4072" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">PRY</text>
				</g>
				<rect class="origen" id="PAN_O" ng-show="model_origin_esp.Panama" x="264.015" y="347.712" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="23.351" height="23.349"/>
				<rect id="PAN_D" ng-show="model_destiny_esp.Panama" x="264.015" y="347.712" fill="none" stroke="#1D1E3D" stroke-miterlimit="10" width="23.351" height="23.349"/>
				<g>
					<text id="PAN_T" ng-show="model_destiny_esp.Panama || model_origin_esp.Panama" x="265.1572" y="362.6016" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">PAN</text>
				</g>
				...
				<g>
					<text id="ESP_T" ng-show="model_destiny_esp.Espa || model_origin_esp.Espa" x="124.0581" y="673.4189" fill="#1D1D1B" font-family="'Roboto-Regular'" font-size="11">ESP</text>
				</g>
				<g>
					<g>
			...
			<a href="https://www.dropbox.com/sh/pnu71cvs8n70dco/AABFXfP3QSXCLMgvPdg07YsNa?dl=0" target="_blank">
				<img src="images/btn_descarga_esp.png" class="boton">
			</a>
		</div>
		<div class="footer">
			<div class="d4">
