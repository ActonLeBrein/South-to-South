					...
					rec.attr("x", x)
	     			   ...
	     			   .on("click", function(){	     			   		
	     			   		...
	     			   		scope.$apply(function(){
	     			   			...
	     			   			scope.select_ctry = scope.paises[id].esp;
					...
					rec.attr("x", x)
	     			   ...
	     			   .on("click", function(){
	     			        var id = $(this).attr("id").split("_")[0];
	     			   		...
	     			   		console.log("Destiny:");
	     			   		console.log(scope.select_destiny);	     			   		
	     			   		scope.tooltip = true;	     			   		
		...
		<div class="ocultar_menu">		
			<div class="header">
				<div class="lang_version">
	   			...
	   			<div id="title_main">Migración iberoamericana: más allá de Estados Unidos</div>				
	  		</div>
			<hr class="header_line">
			<div class="title">
				Mientras que España expulsó el mayor número de migrantes, 4.4 millones, a otros países iberoamericanos entre 1960 y 2010, Argentina recibió el mayor número, con 7.1 millones.
			</div>		
			<hr class="title_line">
		</div>
		<div class="contenido">
			<div class="modal" ng-show="modal">
				<div id="contenedor_instrucciones" ng-show="instrucciones">
					...
					<p>Estás viendo el total de migrantes que salieron y entraron de un país iberoamericano para 2010. Te puedes mover en la línea de tiempo al darle clic a años anteriores para ver si las cifras han cambiado. Si solo te interesa ver el cruce entre dos o más países, puedes hacerlo al seleccionar en los menus de origen y destino. Haz clic en los países para comparar las cifras de salida y entrada.</p>
				</div>
			...
			<div class="menu_paises">
				<div id="menu_origen" class="menu" ng-show="menu == 1">
					...
					<div class="checkboxFive" ng-repeat="pais in countries_esp">
						<input class="check" id="{{pais}}_O" type="checkbox" name="pais" ng-model="model_origin_esp[pais.split(' ')[0].split('á')[0].split('é')[0].split('í')[0].split('í')[0].split('ú')[0].split('ñ')[0]]">
				...
				<div id="menu_destino" class="menu" ng-show="menu == 2">
					...
					<div class="checkboxFive" ng-repeat="pais in countries_esp">
						<input class="check" id="{{pais}}_D" type="checkbox" name="pais" ng-model="model_destiny_esp[pais.split(' ')[0].split('á')[0].split('é')[0].split('í')[0].split('í')[0].split('ú')[0].split('ñ')[0]]">
			...
			<div class="nota">
				...
				<div class="parrafo">
					<p>Los datos son del Banco Mundial y los puedes descargar en la sección de <a href="http://econ.worldbank.org/WBSITE/EXTERNAL/EXTDEC/EXTDECPROSPECTS/0,,contentMDK:22803131~pagePK:64165401~piPK:64165026~theSitePK:476883,00.html" target="_blank">Migración Bilateral y Remesas</a>
				</div>
			</div>
